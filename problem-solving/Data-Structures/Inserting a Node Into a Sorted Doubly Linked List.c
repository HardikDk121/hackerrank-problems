...
DoublyLinkedListNode* sortedInsert(DoublyLinkedListNode* llist, int data) {
    struct DoublyLinkedListNode *newnode=(struct DoublyLinkedListNode*)malloc(sizeof( struct DoublyLinkedListNode)) ,*current ,*tail;
    ...
    for(current =llist ; current !=NULL && current ->data < data ; tail=current ,current = current->next);
    if(current != NULL)
    {
