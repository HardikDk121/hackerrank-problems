...
SinglyLinkedListNode* mergeLists(SinglyLinkedListNode* head1, SinglyLinkedListNode* head2)
{
    ...
    struct SinglyLinkedListNode *head3 = NULL ;
    ...
    struct SinglyLinkedListNode *tail = head3;        
    while (head1 != NULL && head2 != NULL)
    {
        struct SinglyLinkedListNode *newnode =(SinglyLinkedListNode *)malloc(sizeof(SinglyLinkedListNode));
        if (head1 ->data < head2 ->data)
        {
